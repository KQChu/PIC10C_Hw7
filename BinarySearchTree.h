...
/**	@class BinarySearchTree
	@brief The BinarySearchTree class is designed to create a Binary Search Tree of T values.  It contains a pointer to its root TreeNode.  Functions have been included to insert new T values, delete T values, determine whether a T value exists with the object, and provide functions to get the smallest and largest T value.  This class has the copy and swap idiom implemented and a recursive destructor.  By default, the BinarySearchTree class is templated with std::less as type CMP.
  */
...
public:
    ...
    /**	The virtual destructor calls the recursive destructor function to delete the TreeNodes
     */
...
/**	Counts the number of times the input data value appears in BinarySearchTree. Utilizes the recursive find(T value) TreeNode function to cycle through the BinarySearchTree
...
/**	Cycles through TreeNodes of a BinarySearchTree recursively to call delete. Utilized in BinarySearchTree destructor to eliminate memory leaks
