...
/**	@class TreeIterator
	@brief The TreeIterator clss is a bidirectional iterator for the BinarySearchTree class.  Each TreeITerator object has a pointer to a TreeNode and BinarySearchTree that it belongs to.  Following the standard for bidirectional iterators, operator++/-- (prefix and postfix), == , !=, *, and -> have been overloaded.  The default constructor, copy constructor, and assignment operator have also been defined.  The TreeIterator class is templated to be able to handle type T and comparison paramters.  Friendship is grated to the BinarySearchTree class to allow the BST access to the begin() and end() function.
 */
...
TreeIterator<T, CMP>::TreeIterator() {
...
TreeIterator<T, CMP>::TreeIterator(const TreeIterator<T, CMP>& copy) {
